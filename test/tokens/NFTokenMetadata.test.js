...
contract('NFTokenMetadataMock', (accounts) => {
  ...
  it('throws when trying to mint 2 NFTs with the same claim', async () => {
    await nftoken.mint(accounts[0], id2, 'url2');
    await assertRevert(nftoken.mint(accounts[0], id2, 'url2'));
  });
  ...
  it('finds the correct amount of NFTs owned by account', async () => {
    ...
    await nftoken.mint(accounts[1], id3, 'url3');
  ...
  it('corectly transfers NFT from owner', async () => {
    ...
    await nftoken.mint(sender, id2, 'url2');
  ...
  it('corectly transfers NFT from approved address', async () => {
    ...
    await nftoken.mint(owner, id2, 'url2');
